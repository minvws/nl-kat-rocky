...
class OOIGraphView(OOITreeView):
    ...
    def get_filtered_tree(self, tree_dict):
        ...
        return hydrate_tree(filtered_tree, organization_code=self.organization.code)
...
def hydrate_tree(tree, organization_code):
    return hydrate_branch(tree, organization_code)


def hydrate_branch(branch, organization_code):
