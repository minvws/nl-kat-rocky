...
def test_upload_bad_input(rf, my_user, organization, mock_organization_view_octopoes, mock_bytes_client):
    ...
    mock_bytes_client().add_manual_proof.assert_called_once_with(data, manual_mime_types={"manual/csv"})
...
def test_upload_csv(
    ...
    mock_bytes_client().add_manual_proof.assert_called_once_with(example_input, manual_mime_types={"manual/csv"})
